...
public class TestIO : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var uri = new Uri("https://taixiubackend-test.onrender.com");
        ...
        {
            ReceivedText.text += "Received On " + name + " : " + response.GetRawText() + "\n";
        });*/
    }
...
using SocketIOUnity; // Import thư viện đúng
...
public class TestIO : MonoBehaviour
{
    ...
    void Start()
    {
        string serverUrl = "https://taixiubackend-test.onrender.com";
